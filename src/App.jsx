...
export default function App(){
  ...
  return(
    <div className="min-h-screen max-sm space-y-6 p-6">
      <Nav/>
      ...
      <div className="flex flex-col  space-y-4">
        ...
        <button className="font-bold w-3/5 bg-white shadow-lg  text-sm rounded-full p-2 text-center">BROWSE CHALLENGES</button>
      </div>
      </div>
