...
export default function Home(){
  ...
  return(
    <div className="min-h-screen max-sm space-y-10 p-4  lg:px-20">
      <Nav/>
     ...
     <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="flex flex-col   md:flex-row gap-4 md:items-center md:justify-center ">
        <button className="text-white  p-2 font-bold text-sm bg-rose-500 rounded-full w-3/4 text-center flex items-center justify-center gap-4"><a href="https://www.frontendmentor.io/home" className="flex justify-center items-center gap-4">START BUILDING FREE <FaGithub /></a></button>
        <button className="font-bold w-3/5 bg-white shadow-lg p-2 text-sm rounded-full  text-center border border-1 border-gray-200"><a href="https://www.frontendmentor.io/challenges">BROWSE CHALLENGES</a></button>
      </div>
      <div>
      </div>
        </div>
