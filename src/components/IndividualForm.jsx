...
export default function IndividualCard({subDate, deletedDate, datePerMonth, description ,listVal ,forIndividual,activeButtonToggle }){



  return(
    <div className="">
       {activeButtonToggle===forIndividual&&(
            ...
            <ul>
              {listVal.map((val)=>(
                <div className="flex gap-4 items-end space-y-4" key={val} >
