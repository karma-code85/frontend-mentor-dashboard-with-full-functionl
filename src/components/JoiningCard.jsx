...
export default function JoinCard(){
  return(
    <div className="flex flex-col justify-center items-center bg-gray-50 shadow border border-1 rounded-lg p-4 space-y-6 text-center">
      ...
      <button className="font-bold bg-rose-500 text-lg rounded-full text-center p-2  text-white shadow border border-1 "><a href="" className="flex gap-4 items-center">LOGIN<span><FaGithub/></span></a></button>
